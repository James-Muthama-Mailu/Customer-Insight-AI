...
from models.word2vec_model.loading_dataset import sheet  # Import the sheet object from the loading_dataset module
...
# Save the cleaned sentences and intents for further use
with open('../pickle/sentences.pkl', 'wb') as f:
    pickle.dump(filtered_sentences, f)
with open('../pickle/intents.pkl', 'wb') as f:

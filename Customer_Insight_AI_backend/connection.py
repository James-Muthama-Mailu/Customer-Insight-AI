...
connection_string = f"mongodb+srv://jamesmuthaiks:{encoded_password}@customer-insight-ai.hzqx4jw.mongodb.net/?retryWrites=true&w=majority&appName=Customer-Insight-AI&authSource=admin"
